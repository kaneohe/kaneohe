# Kāneʻohe [![Build Status](https://travis-ci.org/kaneohe/kaneohe.svg?branch=master)](https://travis-ci.org/kaneohe/kaneohe)
...
Kāneʻohe uses [Sass](http://Sass-lang.com/) (CSS with superpowers). In short, Sass is a CSS pre-processor that allows you to write styles more effectively and tidy.
...
$ git clone https://github.com/kaneohe/kaneohe.git
$ cd kaneohe
$ npm install
```
...
Please note that you **must** run `npm run build` or `npm run watch` in your terminal for the styles to be copied and concatenated. See the [Gulpfile.js](https://github.com/kaneohe/kaneohe/blob/master/gulpfile.js) for details
...
Please note that you must run `npm run build` or `npm run watch` in your terminal for the scripts to be copied and concatenated. See [Gulpfile.js](https://github.com/kaneohe/kaneohe/blob/master/gulpfile.js) for details
...
1. [Star](https://github.com/kaneohe/kaneohe/stargazers) the project!
2. Answer questions that come through [GitHub issues](https://github.com/kaneohe/kaneoehe/issues)
3. Report a bug that you find
4. Share a theme you've built on top of Kāneʻohe
